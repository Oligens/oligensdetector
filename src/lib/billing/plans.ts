...
export const PLANS:Record<PlanId,PlanDefinition>={
 ...
 flash:{id:"flash",name:"Flash / Découverte",priceMonthlyHTG:65.85,flashDays:7,analysesPerDay:1,maxWordsPerAnalysis:2500,features:["65,85 HTG / mois","1 analyse par jour","Rapports PDF","Historique avancé","Expiration automatique sous 7 jours"]},
