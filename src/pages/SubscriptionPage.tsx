...
export default function SubscriptionPage() {
  ...
  async function checkout() {
    ...
    try {
      const res = await fetch("/api/payments/create", { method: "POST", headers: { "Content-Type": "application/json", Authorization: `Bearer ${(await import("../lib/supabase")).supabase ? (await (await import("../lib/supabase")).supabase!.auth.getSession()).data.session?.access_token ?? "" : ""}` }, body: JSON.stringify({ plan, billingPeriod: period, provider, phone, promoCode: promo }) });
